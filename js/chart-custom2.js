...
if (jQuery("#distperf-column").length) {
	options = {
		chart: {
			height: 350,
			type: "bar"
	...
	(chart = new ApexCharts(document.querySelector("#distperf-column"), options)).render()
}
if (jQuery("#advpageperf-column").length) {
	options = {
		chart: {
			height: 350,
			type: "bar"
		...
		series: [{
			...
			name: "Adv. Value",
			data: [101, 85, 10, 98, 87, 105]
		}],
		xaxis: {
			categories: ["First", "Second", "Third", "Fourth", "Fifth", "Last"]
		},
		yaxis: {
			title: {
				text: "$ (thousands)"
		...
		tooltip: {
			y: {
				formatter: function(e, { seriesIndex }) {
					if (seriesIndex === 0) {
						return e + " pcs";
					}
					return "৳  " + e + " thousand";
	...
	(chart = new ApexCharts(document.querySelector("#advpageperf-column"), options)).render()
}
...
if (jQuery("#advsource-pie-chart").length) {
	options = {
		chart: {
			width: 380,
			type: "pie"
		},
		labels: ["Agency", "walk-in", "Corrospondance", "Phone", "Internal"],
	...
	(chart = new ApexCharts(document.querySelector("#advsource-pie-chart"), options)).render()
}
...
if (jQuery("#am-simple-chart").length && am4core.ready(function() {
	...
	}), jQuery("#wordcount-chart").length && am4core.ready(function() {
		am4core.useTheme(am4themes_animated);
	...
	}), jQuery("#distcoll-chart").length && am4core.ready(function() {
		am4core.useTheme(am4themes_animated);
		var e = am4core.create("distcoll-chart", am4charts.PieChart3D);
		e.hiddenState.properties.opacity = 0, e.legend = new am4charts.Legend, e.data = [{
			country: "Dhaka",
			litres: 50100
		}, {
		...
		var t = e.series.push(new am4charts.PieSeries3D);
		t.colors.list = [am4core.color("#1e3d73"), am4core.color("#fbc647"), am4core.color("#fe517e"), am4core.color("#6ce6f4"), am4core.color("#99f6ca"), am4core.color("#c8c8c8")], t.dataFields.value = "litres", t.dataFields.category = "country"
	}), jQuery("#distperf-chart").length && am4core.ready(function() {
		am4core.useTheme(am4themes_animated);
		var e = am4core.create("distperf-chart", am4charts.PieChart3D);
		e.hiddenState.properties.opacity = 0, e.legend = new am4charts.Legend, e.data = [{
			country: "Dhaka",
			litres: 50100
		}, {
